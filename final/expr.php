...
<center>
	...
	<div class="container">
		<div class="row gutters">
			<form action="exprdb.php" method="GET">
				<div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
					<div class="card h-100">
						<div class="card-body">
							...
							<div class="row gutters">
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<h6 class="mb-3 text-primary">Experience2</h6>
								</div>
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="form-group">
										<label for="Street">Comapny Name2</label>
										<input type="name"  class="form-control" id="Comapny" name="Comapny2" placeholder="Enter Comapny Name" value="">
									</div>
								</div>
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="form-group">
										<label for="Street">Position2</label>
										<input type="name"  class="form-control" id="Comapny" name="Position2" placeholder="Enter Position" value="">
									</div>
								</div>
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="form-group">
										<label for="Street">Year&Month2</label>
										<input type="date"  class="form-control" id="Comapny" name="Year2" placeholder="Enter Comapny Name" value="">
									</div>
								</div>
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="form-group">
										<label for="Street">Experience2</label>
										<input type="name"  class="form-control" id="Comapny" name="Experience2" placeholder="Enter Comapny Name" value="">
									</div>
