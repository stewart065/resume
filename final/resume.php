...
<a href="logout.php">LOGOUT</a>
            ...
            <div class="container">
                ...
                <?php
                        $sql3="SELECT `year`, `school`, `year2`, `school2`, `year3`, `school3`, `image` FROM `educ` order by id desc limit 1";
                        $res3 = $con->query($sql3);
                ...
                <div class="col-lg-7">
                            ...
                            <h5 class="resume-experience-title">Education:</h5>
                                ...
                                <div class="jobster-timeline-info">
                                    <div class="dashboard-timeline-info">
                                        ...
                                        <span>- <?php echo $row3['year']?></span>
                                        <p><?php echo $row3['school']?></p>
                    ...
                    <div class="jobster-timeline-item mb-0">
                        ...
                        <div class="jobster-timeline-info">
                            <div class="dashboard-timeline-info">
                                ...
                                <span>- <?php echo $row3['year2']?></span>
                                <p><?php echo $row3['school2']?></p>
                    ...
                    <div class="jobster-timeline-item mb-0">
                        ...
                        <div class="jobster-timeline-info">
                            <div class="dashboard-timeline-info">
                                ...
                                <span>- <?php echo $row3['year3']?></span>
                                <p><?php echo $row3['school3']?></p>
                        ...
                        <?php
                                 $sql4="SELECT`ComapnyName`,`Position`, `YearMonth`, `Experience`, `ComapnyName2`, `Position2`, `YearMonth2`, `Experience2` FROM `expr` order by id desc limit 1";
                                 $res4 = $con->query($sql4);
                    ...
                    <div class="jobster-timeline-info">
                    <div class="dashboard-timeline-info">
                    <span class="jobster-timeline-time"><?php echo $row4['YearMonth']?></span>
                    <h6 class="mb-2"><?php echo $row4['Position']?></h6>
                    <span>- <?php echo $row4['ComapnyName']?></span>
                    <p class="mt-2"><?php echo $row4['Experience']?></p>
                    </div>
                    </div>
                    </div>
                    <div class="jobster-timeline-item mb-0">
                    ...
                    <div class="jobster-timeline-info">
                    <div class="dashboard-timeline-info">
                    <span class="jobster-timeline-time"><?php echo $row4['YearMonth2']?></span>
                    <h6 class="mb-2"><?php echo $row4['Position2']?></h6>
                    <span>- <?php echo $row4['ComapnyName2']?></span>
                    <p class="mt-2"><?php echo $row4['Experience2']?></p>
                    </div>
                    </div>
                    </div>
                    </div>
                        ...
                        <?php
                                $sql5="SELECT`Reference`, `title`, `comapnyname`, `Email`, `Reference2`, `title2`, `comapnyname2`, `Email2` FROM `characterse` order by id desc limit 1";
                                $res5 = $con->query($sql5);
                    ...
                    <div class="jobster-timeline-info">
                    <div class="dashboard-timeline-info">
                    <span class="jobster-timeline-time"><?php echo $row5['Reference']?></span>
                    <h6 class="mb-2"><?php echo $row5['title']?></h6>
                    <span>- <?php echo $row5['Email']?></span>
                    <p class="mt-2"><?php echo $row5['comapnyname']?></p>
                    </div>
                    </div>
                    </div>
                    <div class="jobster-timeline-item mb-0">
                    ...
                    <div class="jobster-timeline-info">
                    <div class="dashboard-timeline-info">
                    <span class="jobster-timeline-time"><?php echo $row5['Reference2']?></span>
                    <h6 class="mb-2"><?php echo $row5['title2']?></h6>
                    <span>- <?php echo $row5['comapnyname2']?></span>
                    <p class="mt-2"><?php echo $row5['Email2']?></p>
                    </div>
                    </div>
                    </div>
                    </div>
